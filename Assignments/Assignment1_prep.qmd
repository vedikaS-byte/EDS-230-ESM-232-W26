...
```{r}
# Create a solar energy yeild function
# This function takes: area (A)  and annual solar radiation (H)
# panel yeild (r), performance ratio (PR) are predefined 
r <- .2
PR <- .75
solar_production <- function(A, H){
  ...
  print(paste("The total energy produced from solar production is:",energy_solar, "kWh."))
}

## Call the function on made up values
