...
*Yes or No? NO... unitless so does not make sense to compare*
...
[*IF*]{style="color: blue;"} **P** and **T** were in the same units (e.g percent deviation from a mean value), then you could use the coefficients to tell you if parrot suitability would be more sensitive to a 10% change in precipitation versus a 10% change in temperature... **NORMALIZED INPUTS (NOT COEFFICIENTS) LIKE BELOW**
...
-   Sensitivity is often built into coefficients.
...
-   Anomaly (diff from baseline yield)

-   Parameters (in yield or profit)

-   Boxplot comparison of the yield anomaly overtime?
